...
class file_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('key213', 'block_sibportfolio');
    }

    public function get_description() {
        return "The user with id {$this->data['userid']} deleted file with id {$this->data['objectid']} in the portfolio of the user with id {$this->data['relateduserid']}";
    }

...
class claim_delete_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('key214', 'block_sibportfolio');
    }

    public function get_description() {
        return "The user with id {$this->data['userid']} created delete request of the file with id {$this->data['objectid']}";
    }

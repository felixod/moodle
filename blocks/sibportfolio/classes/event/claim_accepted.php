...
class claim_accepted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('key215', 'block_sibportfolio');
    }

    public function get_description() {
        return "The user with id {$this->data['userid']} approved the request with id {$this->data['objectid']} of user with id {$this->data['relateduserid']}";
    }

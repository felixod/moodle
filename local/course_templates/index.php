...
if (!$step) {
    ...
    $html_stepper.= '<span class="bs-stepper-label"><strong style="color:'.$theme_cfg->brandcolor.';">Выберите шаблон</strong></span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    ...
    $html_stepper.= '<span class="bs-stepper-label">Выберите категорию</span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    $html_stepper.= '<div class="line"></div>';
    $html_stepper.= '<div class="step" data-target="#information-part">';
    ...
    $html_stepper.= '<span class="bs-stepper-label">Установите парамерты</span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    $html_stepper.= '</div>';
    echo $html_stepper;
    ...
    $html_stepper.= '<span class="bs-stepper-label">Выберите шаблон</span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    $html_stepper.= '<div class="line"></div>';
    ...
    $html_stepper.= '<span class="bs-stepper-label"><strong style="color:'.$theme_cfg->brandcolor.';">Выберите категорию</strong></span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    $html_stepper.= '<div class="line"></div>';
    $html_stepper.= '<div class="step" data-target="#information-part">';
    ...
    if (!$cid) {
        ...
        echo html_writer::tag('p', html_writer::empty_tag('input', array('type' => 'button', 'value' => 'Назад', 'onclick' => 'javascript :history.back(-1)', 'class' => 'btn btn-primary', 'style' => 'margin-right:20px;')).html_writer::empty_tag('input', array('type' => 'button', 'value' => get_string('continue', 'local_course_templates'), 'onclick' => 'window.location.href="'.$redirecturl.'"', 'class' => 'btn btn-primary')));
    } else {
    ...
    $html_stepper.= '<span class="bs-stepper-label"><strong style="color:'.$theme_cfg->brandcolor.';">Установите парамерты</strong></span>';
    $html_stepper.= '</button>';
    $html_stepper.= '</div>';
    $html_stepper.= '</div>';
